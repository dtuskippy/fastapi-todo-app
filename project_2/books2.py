...
BOOKS = [
    ...
    Book(3, 'Master Endpoints', 'codingwithroby', 'An awesome book!', 5, 2000),
    Book(4, 'HP1', 'Author 1', 'A very nice book!', 2, 2010),
    Book(5, 'HP2', 'Author 2', 'A very nice book!', 3, 2008),
    Book(6, 'HP3', 'Author 3', 'A very nice book!', 1, 2026)
]

@app.get("/", status_code=status.HTTP_200_OK)
async def first_api():
    return {"message": "G-Man rules!"}
    # return "Gizmo rules!"
    # return BOOKS
...
# async def rate_book(book_rating: int):
#     container = []
#     for book in BOOKS:
